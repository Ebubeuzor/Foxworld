        ...
        <div className="p-4">
          <header>
            ...
            <div className="my-4">
              ...
              <span className="ml-4 text-sm">Men ({products.filter(product => product.gender === 'male').length})</span>
              <span className="ml-4 text-sm">Women ({products.filter(product => product.gender === 'female').length})</span>
              <span className="ml-4 text-sm">Children ({products.filter(product => product.gender === 'children').length})</span>
              <span className="ml-4 text-sm">New In ({meta.total})</span>
            ...
            <tbody className="p-5 ">
              ...
              {!loading && selectedDataCheck && selectedData && selectedData.map((product)=> (
                <tr key={product.id} className="p-5">
                  ...
                  <td className="text-center p-4 bg-white">{product.stock}</td>
                  <td className="text-center p-4 bg-white">₦{product.price}</td>
                  <td className="text-center p-4 bg-white">
                    {
                  ...
                  <td className="text-center p-4 bg-white">{product.tag}</td>
